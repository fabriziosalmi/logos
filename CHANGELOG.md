...
- Airgapped dashboard (local CSS/JS, embedded assets)
- Admin-only cache endpoints via `X-Admin-Key`
- Safer middleware (CORS, gzip/304 correctness, rate limit IP handling)
